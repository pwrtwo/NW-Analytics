...
public class Demo2016Activity extends DBActivity implements GestureDetector.OnGestureListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(getString(R.string.title_demo2016));
    ...
    public boolean onFling(MotionEvent motionEvent, MotionEvent motionEvent1, float v, float v1) {
        Intent intent = new Intent(this,Demo2001Activity.class);
