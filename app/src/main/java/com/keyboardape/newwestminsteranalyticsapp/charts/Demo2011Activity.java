...
public class Demo2011Activity extends DBActivity implements GestureDetector.OnGestureListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(getString(R.string.title_demo2011));
    ...
    public boolean onFling(MotionEvent motionEvent, MotionEvent motionEvent1, float v, float v1) {
        Intent intent = new Intent(this,Demo2016Activity.class);
